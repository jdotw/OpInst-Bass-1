...
void _rotpic_handle_state(uint8_t bus, uint8_t channel, uint8_t pic,
  ...
  if (bus == I2C_LEFT) {
    ...
    case 0:
      ...
      case 0:
        // Left 0:000
        ctrl_apply_delta(ctrl, ENC_OSC1_SAW, state.enc1_delta);
        ctrl_apply_delta(ctrl, ENC_OSC1_SQU, state.enc2_delta);
        ctrl_apply_delta(ctrl, ENC_OSC1_TO_OSC2, state.enc4_delta);
        ctrl_apply_toggle(toggle, ENC_OSC1_SQU, state.sw2_changed,
                          state.sw2_state);
        break;
      case 1:
        // Left 0:001
        ctrl_apply_delta(ctrl, ENC_OSC1_DRIVE, state.enc1_delta);
        ctrl_apply_delta(ctrl, ENC_OSC1_FILT_RES, state.enc2_delta);
        ctrl_apply_delta(ctrl, ENC_OSC1_TUNE, (state.enc3_delta * -1));
        ctrl_apply_delta(ctrl, ENC_OSC1_FILT_CUTOFF, (state.enc4_delta * -1));
        ctrl_apply_toggle(toggle, ENC_OSC1_TUNE, state.sw1_changed,
                          state.sw1_state);
        break;
      case 2:
        // Left 0:010
        ctrl_apply_delta(ctrl, ENC_OSC_FILT_ENV_A, (state.enc1_delta * -1));
        ctrl_apply_delta(ctrl, ENC_OSC_FILT_ENV_S, (state.enc2_delta * -1));
        ctrl_apply_delta(ctrl, ENC_OSC_FILT_ENV_D, (state.enc3_delta * -1));
        ctrl_apply_delta(ctrl, ENC_OSC_FILT_ENV_R, (state.enc4_delta * -1));
      ...
      case 3:
        // Left 0:011
        ctrl_apply_delta(ctrl, ENC_OSC2_SAW, state.enc1_delta);
        ctrl_apply_delta(ctrl, ENC_OSC2_NOISE, state.enc2_delta);
        ctrl_apply_delta(ctrl, ENC_OSC2_SQU, state.enc3_delta);
        ctrl_apply_toggle(toggle, ENC_OSC2_SQU, state.sw1_changed,
                          state.sw1_state);
        break;
      case 4:
        // Left 0:100
        ctrl_apply_delta(ctrl, ENC_SUB, (state.enc3_delta * -1));
        ctrl_apply_delta(ctrl, ENC_SUB_NOISE, (state.enc1_delta * -1));
        ctrl_apply_delta(ctrl, ENC_SUB_TO_OSC2, (state.enc2_delta * -1));
        break;
      }
      break;
    case 2:
      ...
      case 0:
        // Left 2:000
        ctrl_apply_delta(ctrl, ENC_SUB_FILT_ENV_A, state.enc3_delta);
        ctrl_apply_delta(ctrl, ENC_SUB_FILT_ENV_D, state.enc1_delta);
        ctrl_apply_delta(ctrl, ENC_SUB_FILT_ENV_S, state.enc4_delta);
        ctrl_apply_delta(ctrl, ENC_SUB_FILT_ENV_R, state.enc2_delta);
      ...
      case 1:
        // Left 2:001
        ctrl_apply_delta(ctrl, ENC_SUB_FILT_CUTOFF, (state.enc1_delta * -1));
        ctrl_apply_delta(ctrl, ENC_SUB_FILT_RES, (state.enc2_delta * -1));
      }
      break;
    case 3:
      // Left I2C 3
      ...
      case 0:
        ...
        if (oled_state == OLED_NAME_PRESET) {
          ...
          if (toggle->fx_wetdry_func == ENC_FX_WETDRY_PRESET) {
            ...
            ctrl_apply_delta(ctrl, ENC_FX_WETDRY, (state.enc4_delta * -1));
          }
        }
        break;
      }
    ...
    case 0:
      ...
      case 0:
        // Right 0:000
        ctrl_apply_delta(ctrl, ENC_OSC_AMP_ENV_D, (state.enc1_delta * -1));
        ctrl_apply_delta(ctrl, ENC_OSC_AMP_ENV_R, (state.enc2_delta * -1));
        ctrl_apply_delta(ctrl, ENC_OSC_AMP_ENV_A, (state.enc3_delta * -1));
        ctrl_apply_delta(ctrl, ENC_OSC_AMP_ENV_S, (state.enc4_delta * -1));
    ...
    case 1:
      ...
      case 0:
        ...
        ctrl_apply_delta(ctrl, ENC_FX_VAL2, (state.enc1_delta * -1));
        ctrl_apply_delta(ctrl, ENC_FX_VAL3, state.enc3_delta);
        ctrl_apply_delta(ctrl, ENC_FX_VAL4, (state.enc2_delta * -1));
        break;
      case 1:
        // Right 1:001
        ctrl_apply_delta(ctrl, ENC_SUB_AMP_ENV_A, (state.enc1_delta * -1));
        ctrl_apply_delta(ctrl, ENC_SUB_AMP_ENV_D, (state.enc3_delta * -1));
        ctrl_apply_delta(ctrl, ENC_SUB_AMP_ENV_S, (state.enc2_delta * -1));
        ctrl_apply_delta(ctrl, ENC_SUB_AMP_ENV_R, (state.enc4_delta * -1));
