...
note_value_t note_value = {.note_number = MIDI_NOTE_A3, 0};

note_changed_t note_changed = {0};

note_trig_t note_trig = {0};
...
void note_changed_reset() { memset(&note_changed, 0, sizeof(note_changed_t)); }
