...
uint8_t _12_to_8(uint16_t a) { return a >> 4; }
...
rgb_14 _interpolate_rgb(rgb_14 in1, rgb_14 in2) {
  double t = 0.5;
  rgb_14 out = {
      .r = in1.r > in2.r ? in2.r + ((in1.r - in2.r) * t)
                         : in1.r + ((in2.r - in1.r) * t),
      .g = in1.g > in2.g ? in2.g + ((in1.g - in2.g) * t)
                         : in1.g + ((in2.g - in1.g) * t),
      .b = in1.b > in2.b ? in2.b + ((in1.b - in2.b) * t)
                         : in1.b + ((in2.b - in1.b) * t),
  };
  return out;
}
...
hsv _oklab_to_hsv(lab_t in) { return _rgb_to_hsv(_oklab_to_rgb(in)); }

lab_t _hsv_to_oklab(hsv in) { return _rgb_to_oklab(_hsv_to_rgb(in)); }
...
void increment_pattern_step() { pattern_step--; }
