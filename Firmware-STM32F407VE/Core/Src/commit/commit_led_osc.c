...
//  hsv osc1 = _osc1_drive_hsv();
//  hsv osc2 = _osc2_drive_hsv();
//  rgb_14 osc1_rgb = _hsv_to_rgb(osc1);
//  rgb_14 osc2_rgb = _hsv_to_rgb(osc2);
//  rgb_14 mix_rgb = _interpolate_rgb(osc1_rgb, osc2_rgb);
