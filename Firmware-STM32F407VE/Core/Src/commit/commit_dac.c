...
void commit_dac(ctrl_t *ctrl) {
  ...
  if (commit_note_value.note_number ||
    ...
    uint8_t osc1_note = commit_note_value.note_number +
                        ctrl->value[CTRL_OSC1_TUNE_COARSE];
